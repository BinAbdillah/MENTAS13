/* =========================================================
menu-kanan.js — REFACTOR v2
anchor section kini menuju index.html#… (aman di subpage)
========================================================= */
(function () {
  const DAFTAR = [
    ['index.html', 'Beranda'],
    ...
    ['galeri.html', 'Galeri'],
    ['index.html#profil', 'Profil Wilayah'],
    ['index.html#agenda', 'Agenda'],
    ['index.html#kontak', 'Kontak']
  ];
  function pasang() {
    if (document.getElementById('menuKanan')) return;
    ...
    host.innerHTML = `
      <div class="menu-kanan" id="menuKanan">
        ...
        <nav class="menu-popup" id="menuPopup">
          ...
          ${DAFTAR.map(([h, l]) => {
            const aktif = !h.includes('#') && h.toLowerCase() === cur;
    ...
    wrap.querySelectorAll('a').forEach((a) => a.addEventListener('click', () => setBuka(false)));
  }
