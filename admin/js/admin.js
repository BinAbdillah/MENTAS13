/* =========================================================
   admin.js — UPLOAD FOTO via GitHub (gratis, tanpa Storage)
   foto → kompresi → commit ke assets/uploads/ → URL Pages
   ========================================================= */
...
/* Repo GitHub = penyimpanan foto (gratis, sudah menghosting situs) */
...
/* =========================================================
   UPLOAD FOTO: kompresi canvas → commit GitHub → URL Pages
   ========================================================= */
...
async function uploadFoto(file) {
  ...
  return GH_PAGES + nama;   // URL publik via GitHub Pages
}
...
$('#formRoot').addEventListener('change', async (e) => {
  ...
  try {
    ...
    status('✅ Foto ter-commit (±1 menit tayang di Pages) — tekan Simpan untuk menyimpan datanya.');
  } catch (err) {
